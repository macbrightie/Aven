...
const faqs = [
  {
    ...
    answer: "Deylon uses advanced AI to analyze your goals, habits, and constraints shared during our initial deep-dive conversation. It then synthesizes this into a structured, executable roadmap broken down by year, month, and day.",
  },
  {
    question: "Is Deylon really free to start?",
  ...
  },
  {
    ...
    answer: "We believe in meeting you where you already are. Instead of asking you to download another app you'll eventually forget to check, Deylon sends your daily priorities straight to your favorite messaging app.",
  },
  {
      ...
      <div className="space-y-12">
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-foreground/60 font-sans">
            Everything you need to know about Deylon.
          </p>
        </div>
