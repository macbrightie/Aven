export function Features() {
  const features = [
    ...
    },
    {
      ...
      description: "Life happens. Deylon learns from your progress and adapts your plan as your situation evolves.",
    },
    {
      title: "Privacy First",
      ...
      <div className="space-y-20">
        <div className="space-y-6 max-w-2xl mx-auto">
          ...
          <p className="text-[18px] text-foreground/60 font-sans">
            Most planners fail because they're too rigid. Deylon is built to be as fluid and dynamic as your life.
          </p>
        </div>
