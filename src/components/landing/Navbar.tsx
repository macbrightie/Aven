...
export function Navbar() {
  ...
  return (
    <>
      <nav className={`flex items-center justify-between py-4 md:py-6 px-[12px] md:px-8 max-w-7xl mx-auto w-full sticky top-0 z-50 transition-all duration-300 ${scrolled ? 'bg-[#1a1a1a] shadow-md' : 'bg-transparent mix-blend-difference'}`}>
