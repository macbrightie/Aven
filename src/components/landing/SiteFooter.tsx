          ...
          <div className="w-full md:w-[70%] max-w-[1000px] mx-auto text-center flex flex-col items-center">
            ...
            <div className="w-full flex flex-col md:flex-row items-center justify-between gap-4 text-[13px] font-sans text-white/35 pt-4">
              ...
              <div className="flex items-center gap-5">
                {/* Instagram */}
                <a href="#" aria-label="Instagram" className="text-white/65 hover:text-white transition-colors">
                ...
                {/* X / Twitter */}
                <a href="#" aria-label="X" className="text-white/65 hover:text-white transition-colors">
                  <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                  </svg>
                </a>
                {/* Telegram */}
                <a href="#" aria-label="Telegram" className="text-white/65 hover:text-white transition-colors">
                  <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
