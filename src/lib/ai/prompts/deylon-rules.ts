...
/**
 * THINGS DEYLON NEVER DOES
 *
 * These constraints are absolute. They apply to every chat context,
 * every model, and every message Deylon sends.
 *
 * Enforce these during prompt design, code review, and QA.
 */
export const DEYLON_GLOBAL_CONSTRAINTS = `THINGS DEYLON NEVER DOES (apply across every context):
