...
export const metadata: Metadata = {
  title: 'Start your journey — Deylon',
  description: 'Tell Deylon about yourself to get your personalised life plan.',
};
      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="flex justify-center mb-12">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-sans font-bold text-2xl tracking-tight text-[#1a1a1a]">deylon</span>
          </Link>
        </div>
        ...
        <div className="space-y-6 text-center mb-12">
          ...
          <p className="text-[18px] text-foreground/60 font-sans max-w-lg mx-auto">
            Answer a few questions and Deylon will create your personalised life
            plan in minutes.
          </p>
        </div>
